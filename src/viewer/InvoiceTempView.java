 ...
 */
public class InvoiceTempView extends javax.swing.JFrame {

    /**
     * Creates new form ginPart2
     */
    public InvoiceTempView() {
        initComponents();
        FirstLoad();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvoiceTempView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
