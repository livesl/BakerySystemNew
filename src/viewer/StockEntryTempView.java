 ...
 */
public class StockEntryTempView extends javax.swing.JFrame {

    /**
     * Creates new form ginPart2
     */
    public StockEntryTempView() {
        initComponents();
        FirstLoad();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockEntryTempView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockEntryTempView().setVisible(true);
            }
        });
    }
